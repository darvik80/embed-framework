...
public:
    ...
    [[nodiscard]] const CogitorCredentials& credentials() const { return *credentials_; }
...
private:
    const CogitorCredentials* credentials_ = nullptr;
