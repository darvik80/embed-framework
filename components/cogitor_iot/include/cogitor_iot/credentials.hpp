...
/// MQTT credentials for Cogitor IoT Platform.
///
...
class CogitorCredentials : public embed::MqttCredentials {
public:
    CogitorCredentials() = default;

    /// Production path: token from dashboard device registration.
    static std::optional<CogitorCredentials> createAccessToken(
    ...
    /// Prefer createAccessToken() for Cogitor platform devices.
    static std::optional<CogitorCredentials> createBasic(
        std::string_view productId,
        std::string_view deviceId,
        std::string_view host,
...
private:
    ...
    CogitorCredentials(std::string productId,
                       std::string deviceId,
                       std::string username,
                       std::string password,
                       std::string clientId,
    ...
    static std::optional<CogitorCredentials> build(std::string_view productId,
                                                   std::string_view deviceId,
                                                   std::string_view host,
                                                   std::string_view username,
                                                   std::string_view password,
